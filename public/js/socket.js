...
(function(){
    ...
    var a={ 
        ...
        init:function(){ 
            var liboday = '';
            var arr = [
                    { id: 1, url: "images/s128x96_XtDL7D3SY6QJGHzc.JPG", title:"皇后湾灯塔" },
                    { id: 2, url: "images/s128x96_DV33SrtGF0EkrA3F.JPG", title:"白云之上"   },
                    { id: 3, url: "images/s128x96_boiCqhjGmojNGguS.JPG", title:"大东海霞光" },
                    { id: 4, url: "images/s128x96_Gpsv0Kx15IEcJi7E.JPG", title:"皇后湾浅滩" },
                    { id: 5, url: "images/s128x96_Jku0EImlopNsh65J.JPG", title:"香水湾滩头" },
                    { id: 6, url: "images/s128x96_XtDL7D3SY6QJGHzc.JPG", title:"皇后湾灯塔" },
                    { id: 7, url: "images/s128x96_DV33SrtGF0EkrA3F.JPG", title:"白云之上"   },
                    { id: 8, url: "images/s128x96_Gpsv0Kx15IEcJi7E.JPG", title:"大东海霞光" },
                    { id: 9, url: "images/s128x96_Jku0EImlopNsh65J.JPG", title:"皇后湾浅滩" },
                    { id: 10,url: "images/s128x96_XtDL7D3SY6QJGHzc.JPG", title:"香水湾滩头" },
                ];
            $.each( arr, function(index, content) { 
                if (content.id == 1) {
                    liboday += '<li class="curr">';
                }else{
                    liboday += '<li>';
                };
                liboday += '<img width="128" height="96" name="'+ content.url +'" alt=""'; 
                liboday += ' title="'+ content.title+'"  src="'+ content.url +'"/>';
                liboday += '</li>'
                
                $("#spec-ul").html(liboday);
                });
                ...
                $("#spec-ul").html(liboday);
                    ...
                    var h=$("#spec-list").find("li").length;
                    // console.log($("#spec-ul").html())
